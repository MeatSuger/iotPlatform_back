...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldAccount, user.FieldPasswd, user.FieldRole, user.FieldStatus:
