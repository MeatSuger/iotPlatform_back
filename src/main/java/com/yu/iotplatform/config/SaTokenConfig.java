    ...
    public SaServletFilter getSaServletFilter() {
        return new SaServletFilter()
                ...
                .setAuth(obj -> {
                    ...
                    SaRouter.match("/**").notMatch("/*/login", "/*/register").check(StpUtil::checkLogin);
                    // 更多拦截处理方式，请参考“路由拦截式鉴权”章节 */
                    System.out.println("---------- 进入全局认证 -----------");
                })
                ...
                .setError(e -> {
                    ...
                    return JSON.toJSONString(ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(e.getMessage()));
                })
